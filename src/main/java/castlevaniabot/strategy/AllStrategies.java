...
public class AllStrategies {
    ...
    public AllStrategies(CastlevaniaBot castlevaniaBot, BotState botState, GameState gameState, PlayerController playerController) {
        ...
        BONE_TOWER = new BoneTowerStrategy(castlevaniaBot, botState, gameState, playerController);
        CANDLES = new CandlesStrategy(castlevaniaBot, botState, gameState, playerController);
        COOKIE_MONSTER = new CookieMonsterStrategy(castlevaniaBot, botState, gameState, playerController);
        ...
        DRACULA = new DraculaStrategy(castlevaniaBot, botState, gameState, playerController);
        EAGLE = new EagleStrategy(castlevaniaBot, botState, gameState, playerController);
        FIREBALL = new FireballStrategy(castlevaniaBot, botState, gameState, playerController);
        FIRE_COLUMN = new FireColumnStrategy(castlevaniaBot, botState, gameState, playerController);
        FISHMAN = new FishmanStrategy(castlevaniaBot, botState, gameState, playerController);
        FLEAMAN = new FleamanStrategy(castlevaniaBot, botState, gameState, playerController);
        FRANKENSTEIN = new FrankensteinStrategy(castlevaniaBot, botState, gameState, playerController);
        GET_CRYSTAL_BALL = new GetCrystalBallStrategy(castlevaniaBot, botState, gameState, playerController);
        GET_ITEM = new GetItemStrategy(castlevaniaBot, botState, gameState, playerController);
        GHOST = new GhostStrategy(castlevaniaBot, botState, gameState, playerController);
        GHOUL = new GhoulStrategy(castlevaniaBot, botState, gameState, playerController);
        GIANT_BAT = new GiantBatStrategy(castlevaniaBot, botState, gameState, playerController);
        GOT_CRYSTAL_BALL = new GotCrystalBallStrategy(castlevaniaBot, botState, gameState, playerController);
        ...
        MEDUSA = new MedusaStrategy(castlevaniaBot, botState, gameState, playerController);
        MEDUSA_HEAD = new MedusaHeadStrategy(castlevaniaBot, botState, gameState, playerController);
        ...
        MUMMIES = new MummiesStrategy(castlevaniaBot, botState, gameState, playerController);
        NO_JUMP_MOVING_PLATFORM = new NoJumpMovingPlatformStrategy(castlevaniaBot, botState, gameState, playerController);
        PANTHER = new PantherStrategy(castlevaniaBot, botState, gameState, playerController);
        PHANTOM_BAT = new PhantomBatStrategy(castlevaniaBot, botState, gameState, playerController);
        RAVEN = new RavenStrategy(castlevaniaBot, botState, gameState, playerController);
        RED_BAT_DAMAGE_BOOST = new RedBatDamageBoostStrategy(castlevaniaBot, botState, gameState, playerController);
        RED_BAT = new RedBatStrategy(castlevaniaBot, botState, gameState, playerController);
        RED_BONES = new RedBonesStrategy(castlevaniaBot, botState, gameState, playerController);
        RED_SKELETON = new RedSkeletonStrategy(castlevaniaBot, botState, gameState, playerController);
        ...
        SNAKE = new SnakeStrategy(castlevaniaBot, botState, gameState, playerController);
        SPEAR_KNIGHT = new SpearKnightStrategy(castlevaniaBot, botState, gameState, playerController);
        USE_WEAPON = new UseWeaponStrategy(castlevaniaBot, botState, gameState, playerController);
        WAIT = new WaitStrategy(castlevaniaBot, botState, gameState, playerController);
        WHITE_SKELETON = new WhiteSkeletonStrategy(castlevaniaBot, botState, gameState, playerController);
