...
public class GiantBatStrategy implements Strategy {
    ...
    public GiantBatStrategy(final CastlevaniaBot b, final BotState botState, final GameState gameState, final PlayerController playerController) {
        this.b = b;
    ...
    public void step() {
        ...
        if (jumpCounter > 0) {
            ...
            if (landX >= 0
                    && gameState.getCurrentSubstage().mapRoutes.map[botState.getCurrentTile().getY()][landX >> 4].height == 0) {
