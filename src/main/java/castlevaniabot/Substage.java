...
public abstract class Substage {
  ...
  void moveToward(final GameObject obj) {
    if (obj.onPlatform) {
  ...
  abstract void routeLeft();
  abstract void routeRight();  
  abstract void readGameObjects();
}